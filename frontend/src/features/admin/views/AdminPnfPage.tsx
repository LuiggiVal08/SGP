              ...
              <Modal.Body>
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    <label htmlFor="pnf-name" className="text-sm">Nombre</label>
                    <Input
                      id="pnf-name"
                  ...
                  <div className="flex flex-col gap-1">
                    <label htmlFor="pnf-institution" className="text-sm">Institución</label>
                    <Select
                      id="pnf-institution"
          ...
          <Modal.Container size="sm">
            <Modal.Dialog className="sm:max-w-[360px] max-h-[85vh] overflow-hidden">
              ...
              <Modal.Body>
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    <label htmlFor="edit-pnf-name" className="text-sm">Nombre</label>
                    <Input
                      id="edit-pnf-name"
                  ...
                  <div className="flex flex-col gap-1">
                    <label htmlFor="edit-pnf-institution" className="text-sm">Institución</label>
                    <Select
