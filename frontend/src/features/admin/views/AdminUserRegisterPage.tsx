  ...
  return (
    <div className="mx-auto max-w-lg">
      ...
      <div className="relative mb-6">
        ...
        <h2 className="font-display text-2xl font-bold tracking-tight pl-3">Registrar Usuario</h2>
      </div>
      ...
      <Card.Root variant="secondary" className="border border-border">
        <Card.Content className="p-6 space-y-4">
          <form onSubmit={handleSubmit((data) => mutation.mutate(data))} className="space-y-4">
            ...
            <div className="flex flex-col gap-1">
              <FieldLabel label="Rol" help="Rol del usuario en el sistema" htmlFor="roleName" className="text-sm" />
              <Select
                aria-label="Rol"
